...
class New_Credentials(QtWidgets.QWidget):

    def __init__(self, communicate):
        super(New_Credentials, self).__init__()
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.resize(967, 345)
        self.acces_configuration = QtWidgets.QGroupBox(Dialog)
        self.acces_configuration.setGeometry(QtCore.QRect(20, 10, 931, 321))
        font = QtGui.QFont()
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(301, 171, 601, 101))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.save_credentials.setGeometry(QtCore.QRect(810, 290, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.type_access.setGeometry(QtCore.QRect(20, 170, 131, 121))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.type_oauth.setGeometry(QtCore.QRect(161, 171, 131, 121))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.groupBox = QtWidgets.QGroupBox(self.acces_configuration)
        self.groupBox.setGeometry(QtCore.QRect(20, 30, 881, 51))
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.groupBox)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(9, 10, 861, 26))
        ...
        self.select_path = QtWidgets.QPushButton(self.horizontalLayoutWidget_3)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.acces_configuration)
        self.groupBox_2.setGeometry(QtCore.QRect(20, 90, 881, 71))
        self.groupBox_2.setTitle("")
        self.groupBox_2.setObjectName("groupBox_2")
        self.formLayoutWidget = QtWidgets.QWidget(self.groupBox_2)
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 10, 861, 51))
        ...
        self.save_credentials.raise_()
        self.type_access.raise_()
        self.type_oauth.raise_()
        self.groupBox.raise_()
        self.listView = QtWidgets.QListView(Dialog)
        self.listView.setGeometry(QtCore.QRect(-150, -40, 1201, 441))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.save_credentials.setText(_translate("Dialog", "Save"))
        ...
        self.select_path.setText(_translate("Dialog", "Select"))
        self.label.setText(_translate("Dialog", "Consumer Key:"))
        self.label_2.setText(_translate("Dialog", "Consumer Secret Key:"))

    # Visual and Logical configurations of the New Credentials Window.
    def Config(self):
        ...
        self.select_path.clicked.connect(lambda: self.slt_path())
        self.setWindowTitle('Extraction Configuration')
        self.setWindowIcon(QIcon('network.png'))

    # Show a browser window to select the save path for credentials.
    def slt_path(self):
        file = str(QtWidgets.QFileDialog.getExistingDirectory(self, "Select Directory"))
        if (len(file) != 0):
            self.path.setText(file)

    # Visual configuration of each type of authentication.
    ...
    # Save in JSON format the information of the credentials on the path specified by user.
    def save_cred(self):

        if(self.standard.isChecked()):
            if(self.consumer_key.text() and self.consumer_secret_key.text() and self.access_token.text() and self.aceess_secret_token.text() and self.name.text() and self.path.text()):
            ...
            if(self.bearer_token.text() and self.path.text() and self.name.text()):
    ...
    # Returns the absolute path of the credentials
    def ret_filename(self):
        return self.path.text() + "/" + self.name.text() + ".json"