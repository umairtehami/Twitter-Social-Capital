        ...
        while member < len(self.list.profiles):
            ...
            if ("data" in json_response):
                for tweet in json_response["data"]:
                    # Check if the Tweet is not an Retweet
                    if (not "referenced_tweets" in tweet):
                        if ("entities" in tweet):
                            if ("mentions" in tweet["entities"]):
                                for mention in tweet["entities"]["mentions"]:
                                    # For each mention, create a new relation
                        ...
                        # If is Quoted Tweet, check if it have any mention
                                    ...
                                    for mention in tweet["entities"]["mentions"]:
                                        ...
                                        if (name != ""):
                                            ...
                                            if (not relation.existing_relation(relations)):
                                                relations.append(relation)
                if ("next_token" in json_response["meta"]):
                    # Obtain the token to acces the next data page if exists and repeat the process
                    while json_response["meta"]["next_token"] != 0:
